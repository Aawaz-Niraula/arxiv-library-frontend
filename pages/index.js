...
export default function Home() {
  ...
  return (
    <>
      ...
      <div className="appShell" style={{ opacity: mounted ? 1 : 0, transition: 'opacity 0.4s' }}>
        <div className="mobileTabs">
          <button
            className={`mobileTabButton ${activeTab === 'library' ? 'mobileTabButtonActive' : ''}`}
          ...
          <button
            className={`mobileTabButton ${activeTab === 'chat' ? 'mobileTabButtonActive' : ''}`}
        ...
        <div className="appContent">
          <aside className={`libraryPanel panelBase ${activeTab === 'library' ? 'panelActiveMobile' : ''}`}>
            <div style={{
                        ...
                        >
                          ...
                          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                            ...
                            <a
                              ...
                              style={{ fontFamily: 'var(--font-mono)', fontSize: '10px', color: 'var(--accent)', minHeight: '44px', display: 'inline-flex', alignItems: 'center' }}
                            >
                              open ↗
                            </a>
                          </div>
                          ...
                          <button
                            onClick={e => deletePaper(e, paper.arxiv_id)}
                            type="button"
                            style={{ position: 'absolute', top: '4px', right: '4px', background: 'none', border: 'none', color: 'var(--faint)', fontSize: '16px', lineHeight: 1, padding: '12px', minWidth: '44px', minHeight: '44px', transition: 'color 0.15s' }}
          ...
          <main className={`chatPanel panelBase ${activeTab === 'chat' ? 'panelActiveMobile' : ''}`} style={{ position: 'relative' }}>
            <div style={{
              position: 'absolute',
              top: '-100px',
              right: '-100px',
            ...
            <div style={{
              ...
              <div style={{ marginLeft: 'auto', display: 'flex', alignItems: 'center', gap: '8px', minWidth: 0 }}>
                <span style={{ fontFamily: 'var(--font-mono)', fontSize: '10px', color: 'var(--muted)', whiteSpace: 'nowrap' }}>
                  {selectedIds.length === 0 ? 'searching all papers' : `${selectedIds.length} paper${selectedIds.length > 1 ? 's' : ''} selected`}
                </span>
              </div>
            </div>

            <div style={{ flex: 1, minHeight: 0, overflowY: 'auto', overflowX: 'hidden', padding: '24px 20px', display: 'flex', flexDirection: 'column', gap: '24px', position: 'relative', zIndex: 1 }}>
              {messages.length === 0 && (
              ...
              {messages.map((msg, i) => (
                <div key={i} style={{ display: 'flex', flexDirection: 'column', alignItems: msg.role === 'user' ? 'flex-end' : 'flex-start' }}>
                  ...
                  {msg.citations?.length > 0 && (
                    <div style={{ maxWidth: '85%', marginTop: '12px' }}>
            ...
            <div style={{
              ...
              <input
                ...
                onFocus={e => {
                  ...
                  e.target.style.boxShadow = '0 0 16px rgba(139,120,255,0.1)'
                }}
                onBlur={e => {
      ...
      <style>{`
        ...
        * { scrollbar-width: thin; scrollbar-color: var(--faint) transparent; }
        ...
        .mobileTabButtonActive {
          ...
          color: var(--accent);
          box-shadow: 0 0 12px rgba(139,120,255,0.2);
        }
